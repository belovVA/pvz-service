...
func (_m *UserRepository) CreateUser(ctx context.Context, user *model.User) (uuid.UUID, error) {
	...
	var r0 uuid.UUID
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *model.User) (uuid.UUID, error)); ok {
		return rf(ctx, user)
	}

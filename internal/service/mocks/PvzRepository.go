...
func (_m *PvzRepository) CreatePvz(ctx context.Context, city string) (uuid.UUID, error) {
...
// GetIDListPvz provides a mock function with given fields: ctx
func (_m *PvzRepository) GetIDListPvz(ctx context.Context) ([]uuid.UUID, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for GetIDListPvz")
	}
...
func (_m *PvzRepository) GetPvzByID(ctx context.Context, id uuid.UUID) (*model.Pvz, error) {
	...
	var r0 *model.Pvz
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) (*model.Pvz, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID) *model.Pvz); ok {
		r0 = rf(ctx, id)
	} else {
		if ret.Get(0) != nil {
